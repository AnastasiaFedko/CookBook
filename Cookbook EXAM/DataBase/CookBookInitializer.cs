...
namespace Сookbook_EXAM
{
    ...
    //public class CookBookInitializer : CreateDatabaseIfNotExists<CookBookContext>
    {
        protected override void Seed(CookBookContext db)
        {
            ...
            Recipe recipe1 = new Recipe(new Bitmap("Бутерброд.jpg")) { Name = "Бутерброд с колбасой", Cuisine = cuisine1, DishType = dishType1, CookTime = new TimeSpan(0, 02, 0) };
            ...
            recipe1.Steps.Add(new Step(new Bitmap("Хлеб.jpg")) { Number = 1, Description = "Отрезать 1 кусок хлеба." });
            recipe1.Steps.Add(new Step(new Bitmap("Колбаса.jpg")) { Number = 2, Description = "Отрезать 1 кусок колбасы." });
            recipe1.Steps.Add(new Step(new Bitmap("Бутерброд.jpg")) { Number = 3, Description = "Положить кусок колбасы на кусок хлеба. Готово!" });

            Recipe recipe2 = new Recipe(new Bitmap("Sangria.jpg")) { Name = "Сангрия", Cuisine = cuisine3, DishType = dishType5, CookTime = new TimeSpan(0, 8, 5) };   
            ...
            recipe2.Steps.Add(new Step(new Bitmap("Sangria1.jpg"))
            {
                Number = 1,
            ...
            recipe2.Steps.Add(new Step(new Bitmap("Sangria2.jpg"))
            {
                Number = 2,
            ...
            recipe2.Steps.Add(new Step(new Bitmap("Sangria3.jpg"))
            {
                Number = 3,
            ...
            recipe2.Steps.Add(new Step(new Bitmap("Sangria4.jpg"))
            {
                Number = 4,
            ...
            Recipe recipe3 = new Recipe(new Bitmap("Майонез.jpg")) { Name = "Майонез", Cuisine = cuisine2, DishType = dishType4, CookTime = new TimeSpan(0, 10, 0) };     
            ...
            recipe3.Steps.Add(new Step(new Bitmap("Майонез1.jpg")) { Number = 1, Description = "Наливаем в миску растительное масло." });
            recipe3.Steps.Add(new Step(new Bitmap("Майонез2.jpg")) { Number = 2, Description = "Добавляем сахар, соль, уксус, горчицу." });
            recipe3.Steps.Add(new Step(new Bitmap("Майонез3.jpg")) { Number = 3, Description = "Добавляем яйцо." });
            recipe3.Steps.Add(new Step(new Bitmap("Майонез4.jpg"))
            {
                Number = 4,
            ...
            Recipe recipe4 = new Recipe(new Bitmap("Луковый пирог.jpg")) { Name = "Луковый пирог с копченым мясом", Cuisine = cuisine4, DishType = dishType2, CookTime = new TimeSpan(1, 50, 0) };
            ...
            recipe4.Steps.Add(new Step(new Bitmap("Луковый пирог1.jpg")) { Number = 1, Description = "Подготовьте все необходимые ингредиенты для приготовления лукового пирога с копчёным мясом." });
            recipe4.Steps.Add(new Step(new Bitmap("Луковый пирог2.jpg")) { Number = 2, Description = "В тёплое молоко всыпьте соль, сахар и дрожжи. Перемешайте." });
            recipe4.Steps.Add(new Step(new Bitmap("Луковый пирог3.jpg")) { Number = 3, Description = "Муку пересыпьте в миску, влейте опару и растопленное и остывшее сливочное масло." });
            recipe4.Steps.Add(new Step(new Bitmap("Луковый пирог4.jpg")) { Number = 4, Description = "Замесите тесто, соберите его в шар и, накрыв миску чистым кухонным полотенцем, поставьте в тёплое место для расстойки на 1 час." });
            recipe4.Steps.Add(new Step(new Bitmap("Луковый пирог5.jpg")) { Number = 5, Description = "За время расстойки теста приготовьте начинку для пирога.Для этого почистите и нарежьте небольшими кубиками репчатый лук." });
            recipe4.Steps.Add(new Step(new Bitmap("Луковый пирог6.jpg")) { Number = 6, Description = "Сливочное масло растопите в сковороде или сотейнике, отправьте туда лук и готовьте на среднем огне до мягкости лука и его прозрачности. Лук не должен стать румяным, его ни в коем случае не следует обжаривать, он скорее должен протушиться. Посолите лук во время приготовления." });
            recipe4.Steps.Add(new Step(new Bitmap("Луковый пирог7.jpg")) { Number = 7, Description = "Когда лук станет прозрачным и мягким, присыпьте его мукой." });
            recipe4.Steps.Add(new Step(new Bitmap("Луковый пирог8.jpg")) { Number = 8, Description = "Лук перемешайте, прогрейте минуту и снимите с плиты." });
            recipe4.Steps.Add(new Step(new Bitmap("Луковый пирог9.jpg")) { Number = 9, Description = "Любое копчёное мясо нарежьте соломкой." });
            recipe4.Steps.Add(new Step(new Bitmap("Луковый пирог10.jpg")) { Number = 10, Description = "Яйцо и сливки соедините в миске, перемешайте вилкой." });
            recipe4.Steps.Add(new Step(new Bitmap("Луковый пирог11.jpg")) { Number = 11, Description = "В другой миске соедините лук, 3/4 всего объёма копчёного мяса, яично-сливочную смесь и тмин." });
            recipe4.Steps.Add(new Step(new Bitmap("Луковый пирог12.jpg")) { Number = 12, Description = "Перемешайте. Начинка для лукового пирога готова." });
            recipe4.Steps.Add(new Step(new Bitmap("Луковый пирог13.jpg")) { Number = 13, Description = "Подошедшее тесто обомните." });
            recipe4.Steps.Add(new Step(new Bitmap("Луковый пирог14.jpg")) { Number = 14, Description = "Тесто раскатайте в пласт и выложите его в форму, формируя бортик высотой примерно 1,5-2 см. (Я выпекала пирог в силиконовой форме диаметром 24 см.)" });
            recipe4.Steps.Add(new Step(new Bitmap("Луковый пирог15.jpg")) { Number = 15, Description = "Начинку распределите поверх теста." });
            recipe4.Steps.Add(new Step(new Bitmap("Луковый пирог16.jpg")) { Number = 16, Description = "Сверху разложите оставшееся копчёное мясо и кусочки сливочного масла." });
            recipe4.Steps.Add(new Step(new Bitmap("Луковый пирог17.jpg")) { Number = 17, Description = "Запекайте луковый пирог в духовке,предварительно разогретой до 180 градусов, 40 минут." });
